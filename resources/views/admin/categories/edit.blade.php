        ...
        <div class="col-12">
            ...
            <form action="{{ route('admin.categories.update', ['category' => $category->id]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Categoria da modificare</label>
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Inserisci la categoria" value="{{ old('name', $category->name) }}" required>
                    @error('name')
