        ...
        <div class="col-12">
            ...
            <form action="{{ route('admin.tags.update', ['tag' => $tag->id]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Tag da modificare</label>
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Inserisci la categoria" value="{{ old('name', $tag->name) }}" required>
                    @error('name')
